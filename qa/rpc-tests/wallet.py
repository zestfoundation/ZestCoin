...
#   c) node1 mines 32 blocks, so now node 0 has 500000ZEST, node 1 has 4250ZEST, node2 has none.
#   d) node0 sends 601 ZEST to node2, in two transactions (301 ZEST, then 300 ZEST).
