...
Intro
-----
Zest (ZEST) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. Zest utilizes an energy efficient proof-of-stake algorithm,
can be mined on any computer, and will never require specialized mining equipment.

Setup
-----
Unpack the files into a directory and run zest-qt.exe.

Zest Core is the original Zest client and it builds the backbone of the network.
However, it downloads and stores the entire history of Zest transactions;
