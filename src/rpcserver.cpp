...
// Copyright (c) 2019 The Zest Foundation developers
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zest features */
        {"zest", "masternode", &masternode, true, true, false},
        {"zest", "listmasternodes", &listmasternodes, true, true, false},
        {"zest", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zest", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zest", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zest", "masternodedebug", &masternodedebug, true, true, false},
        {"zest", "startmasternode", &startmasternode, true, true, false},
        {"zest", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zest", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zest", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zest", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zest", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zest", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zest", "mnbudget", &mnbudget, true, true, false},
        {"zest", "preparebudget", &preparebudget, true, true, false},
        {"zest", "submitbudget", &submitbudget, true, true, false},
        {"zest", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zest", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zest", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zest", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zest", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zest", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zest", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zest", "checkbudgets", &checkbudgets, true, true, false},
        {"zest", "mnsync", &mnsync, true, true, false},
        {"zest", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
...
{
    return "> zest-cli " + methodname + " " + args + "\n";
}
