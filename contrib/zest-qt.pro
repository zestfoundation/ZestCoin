...
RESOURCES += src/qt/zest.qrc src/qt/zest_locale.qrc

TRANSLATIONS += src/qt/locale/zest_bg.ts \
                src/qt/locale/zest_de.ts \
                src/qt/locale/zest_en.ts \
                src/qt/locale/zest_es.ts \
                src/qt/locale/zest_fi.ts \
                src/qt/locale/zest_fr.ts \
                src/qt/locale/zest_it.ts \
                src/qt/locale/zest_ja.ts \
                src/qt/locale/zest_pl.ts \
                src/qt/locale/zest_pt.ts \
                src/qt/locale/zest_ru.ts \
                src/qt/locale/zest_sk.ts \
                src/qt/locale/zest_sv.ts \
                src/qt/locale/zest_vi.ts \
                src/qt/locale/zest_zh_CN.ts \
                src/qt/locale/zest_zh_TW.ts
