...
#if defined(NDEBUG)
#error "Zest cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uzest) are considered zero fee (for relaying and mining)
...
int ActiveProtocol()
{
    if (chainActive.Tip()->nHeight >= 124117)
        return MIN_PEER_PROTO_VERSION_POST_EXPLOIT;
