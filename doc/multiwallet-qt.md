...
In order to support loading of multiple wallets in zest-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zest.cpp.
...
Changes to zest.cpp
----------------------
zest.cpp is the entry point into zest-qt, and as such, will require some minor modifications to provide hooks for
