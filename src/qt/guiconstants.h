...
/* Zest GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Zest"
#define QAPP_ORG_DOMAIN "zestcoin.io"
#define QAPP_APP_NAME_DEFAULT "Zest-Qt"
#define QAPP_APP_NAME_TESTNET "Zest-Qt-testnet"
