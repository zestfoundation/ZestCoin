...
This mechanism has been integrated into Bitcore-Node-Zest which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zest/insight-api-zest#web-socket-api](https://github.com/zest/insight-api-zest#web-socket-api)
* API: [https://github.com/zest/insight-api-zest#swifttx-transactions](https://github.com/zest/insight-api-zest#swifttx-transactions)
...
By default, the Zest Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zest Core daemon:
