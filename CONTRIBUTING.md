Contributing to Zest Core
==================================

The Zest Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Zest Core project, and is not to be
confused with overall Zest Network Protocol consensus changes.

Whether a pull request is merged into Zest Core rests with the project merge
...
Patches that change Zest consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zest consensus, it must have been
...
The project leader is the release manager for each Zest Core release.
